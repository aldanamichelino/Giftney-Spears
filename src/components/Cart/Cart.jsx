...
export const Cart = () => {
    ...
    const { name, img, imgDescription, category, price } = stock.find(producto => producto.id === 5 );
                    ...
                    <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                        <div className="flex w-2/5">
                            ...
                            <div className="flex flex-col justify-between ml-4 flex-grow">
                                ...
                                <a href="#" className="font-semibold hover:text-red-500 text-gray-500 text-xs">Eliminar</a>
                            </div>
                        </div>
